...
public abstract class FakeMeetingGenerator {
    ...
    public static List<Meeting> MEETINGS = Arrays.asList(
            ...
            new Meeting(2, 2,"Devel2022", "Room 2",  new Date(2022, 05, 16, 11, 00), Arrays.asList("ed@sst.com", "paul@lamzone.com", "ali@lamzone.com")),
            ...
            new Meeting(6, 6,"Project Star", "Room 2", new Date(2022, 06, 21, 15, 30), Arrays.asList("lyn@lamzone.com", "ed@sst.com","alex@lamzone.com", "dav@lamzone.com", "rachid@uvt.com"))
        );
